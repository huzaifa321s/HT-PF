...
export const { setMode4, updateTitle, setPageCount, togglePaymentPageInclusion, addTerm, addMultipleTerms, updateTerm, deleteTerm, resetTerms, setDBTerms } = paymentTermsSlice.actions;
