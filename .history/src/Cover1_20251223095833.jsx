...
export const PdfCoverPage = ({
  ...
  return (
    <Page size="A4" style={styles.page}>
      ...
      {/* DEBUG LABEL */}
      <View style={{ position: 'absolute', bottom: 20, left: 20, backgroundColor: 'red', padding: 10, zIndex: 1000 }} fixed>
        <Text style={{ color: 'white', fontSize: 20 }}>DEBUG: COVER 1 RENDERING</Text>
      </View>
    </Page>
  );
};
