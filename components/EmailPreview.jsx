...
${yourName || "Your Name"}`;
  ...
  return (
    ...
    >
      ...
      >
        <InfoOutlined sx={{ color: '#764ba2', fontSize: 24 }} />
        <Typography
          variant="body2"
          sx={{
            color: '#2d3748',
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          ...
          >
            <EmailTwoToneIcon sx={{ fontSize: { xs: 28, sm: 36 }, color: '#667eea' }} />
          </Box>
          <Box>
            <Typography
              variant="h5"
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            {isEditingSubject ? (
              <TextField
                ...
                InputProps={{
                  startAdornment: (
                    <Typography sx={{ fontWeight: 700, color: '#667eea', fontSize: { xs: '0.9rem', sm: '1.1rem' }, mr: 1 }}>
                      📧 Subject:
                    </Typography>
                  ),
                }}
