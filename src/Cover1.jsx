...
const styles = StyleSheet.create({
  ...
  logoTitle: { color: "#FF8C00", fontSize: 22, fontWeight: "bold", letterSpacing: 1.5 },
  logoSubtitle: { color: "#fff", fontSize: 10, letterSpacing: 2.5 },
  mainContainer: { position: "absolute", top: 350, left: 50, right: 60 },
  brandName: {
    color: "#FFF",
    fontSize: 15,
    fontWeight: "bold",
  ...
  proposalBy: { color: "#FFF", fontSize: 15, fontWeight: "bold", marginTop: 40 },
...
return  (
  <Page size="A4" style={styles.page}>
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 0 }}>
        ...
        {/* Premium Gradient Line – Start Bold, End Medium (Not Thin) */}
  ...
  <Svg width="300" height="5">
    ...
    <Rect x="0" y="0" width="300" height="5" fill="url(#grad)" rx="2" />
  </Svg>
</View>
      </View>
