  ...
  const resetAllTerms = async () => {
    ...
    try {
      await axiosInstance.post(
        `/api/proposals/pages/reset/paymentTermsPage/${user.id}`
      );
      dispatch(resetTerms());
      dispatch(
    ...
    >
      <Card sx={cardStyle}>
        <CardContent>
          ...
          {/* Auto-save Alert */}
          <Alert
            icon={<CheckCircle sx={{ color: "#4caf50", fontSize: { xs: 20, sm: 24 } }} />}
            severity="success"
            sx={{
              borderRadius: 4,
          ...
          <Box sx={{ mb: 5, mt: -1 }}>
            <TextField
              fullWidth
              variant="outlined"
              placeholder="Fast Paste: Paste multiple terms..."
              onPaste={handleTermsPaste}
              helperText="Auto-detect lines or bulleted lists."
              sx={{
                "& .MuiOutlinedInput-root": {
                  borderRadius: 3,
            ...
            >
              ...
              {editTitleMode ? (
                ...
                <Tooltip title="Edit title">
                  ...
                  >
                    <Edit fontSize={isVerySmall ? "small" : "medium"} />
                  </IconButton>
                </Tooltip>
              )}
            </Stack>
                        ...
                        <Stack direction="row" spacing={1}>
                          {editIndex === i ? (
                            ...
                            <>
                              ...
                              >
                                <Delete fontSize={isVerySmall ? "small" : "medium"} />
                              </IconButton>
                            </>
                          )}
                        </Stack>
