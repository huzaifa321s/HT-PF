...
//   pageTitle: { fontSize: 20, fontWeight: "bold", color: "#f8fafc", marginBottom: 15 },
//   mainHeading: { fontSize: 32, fontWeight: "bold", color: "#FFA500", textAlign: "center", marginVertical: 15 },
//   subheading: { fontSize: 12, color: "#f8fafc", textAlign: "center", marginBottom: 25, lineHeight: 1.6 },
//   textContent: { fontSize: 11, color: "#f8fafc", marginBottom: 15, lineHeight: 1.6 },
...
//         {/* Left Sidebar */}
//         <Paper sx={{ width: 420, p: 4, overflowY: "auto", bgcolor: "#141414" }}>
//           <Stack spacing={3}>
...
//           {/* PDF Preview */}
//           <Box sx={{ width: "50%", borderLeft: "4px solid #f8fafc", bgcolor: "#141414" }}>
