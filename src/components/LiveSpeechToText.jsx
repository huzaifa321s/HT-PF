            ...
            >
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  ...
                  <Box sx={{ mt: 1, height: 4, bgcolor: 'rgba(0,0,0,0.5)', borderRadius: 2, overflow: 'hidden' }}>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Box sx={{ mt: 1, height: 4, bgcolor: 'rgba(0,0,0,0.5)', borderRadius: 2, overflow: 'hidden' }}>
                    <Box sx={{ height: '100%', width: `${tokenUsage.groq?.percentage}%`, background: 'linear-gradient(135deg, #a855f7 0%, #f59e0b 100%)' }} />
                  </Box>
                </Grid>
              </Grid>
            </Paper>
              ...
              <Grid container spacing={2} sx={{ mb: 3 }}>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    >
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1.5 }}>
                        <AutoAwesome sx={{ color: '#f3a833', fontSize: 18 }} />
                        <Typography variant="subtitle2" fontWeight={700} color="#f3a833">
                          Roman Urdu
                        </Typography>
                      </Box>
                ...
                {englishTranscript && (
                  <Grid item xs={12} md={6}>
                    ...
                    >
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1.5 }}>
                        <Translate sx={{ color: '#f59e0b', fontSize: 18 }} />
              ...
              <Zoom in timeout={600}>
                <Button
                  ...
                  sx={{
                    ...
                    transition: "all 0.3s ease",
                    "&:hover": {
                      boxShadow: "0 12px 32px rgba(243, 168, 51, 0.6)",
                  ...
                  sx={{
                    ...
                    bgcolor:
                      transcriptLength < 100
                        ? "rgba(244, 67, 54, 0.12)"
                        : "rgba(243, 168, 51, 0.08)",
                    border:
                      transcriptLength < 100
                        ? "1px solid rgba(244, 67, 54, 0.3)"
                        : "1px solid rgba(243, 168, 51, 0.2)",
                  }}
                >
                  <Typography
                    variant="body2"
                    sx={{
                      fontWeight: 600,
                      color: transcriptLength < 100 ? "#d32f2f" : "#f3a833",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      gap: 1,
                  ...
                  >
                    {transcriptLength < 100 ? (
                      ...
                      <>
                        <AutoAwesome sx={{ fontSize: { xs: 20, sm: 30 }, color: "#fbbf24" }} />
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'flex-start', mb: 2.5, px: 1 }}>
                        <Paper
                          ...
                          sx={{
                            ...
                            color: liveTranscript ? '#212121' : '#94a3b8'
                          }}
                        >
                          <Typography variant="body1">
                            {liveTranscript || "Listening for Urdu speech..."}
                            <Box component="span" sx={{ display: 'inline-block', width: 6, height: 6, borderRadius: '50%', bgcolor: '#f3a833', ml: 1, animation: 'blink 1s infinite' }} />
                          </Typography>
                        </Paper>
                      </Box>
                    </Fade>
