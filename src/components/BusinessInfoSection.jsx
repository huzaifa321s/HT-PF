...
export default function BusinessInfoSection({ fullTranscript }) {
  ...
  const fetchUsage = async () => {
    try {
      ...
      console.log('--- DEBUG: USAGE FETCH ---');
      console.log('Target URL:', axiosInstance.defaults.baseURL + '/api/tokens/usage');
      ...
      if (isDeliverableTable) {
        return (
          <TableContainer
            ...
            elevation={0}
            sx={{
              boxShadow: "0 4px 12px rgba(243, 168, 51,0.15)",
              borderRadius: 3,
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ background: colorScheme.gradient }}>
                  <TableCell sx={{ fontWeight: 700, color: "#fff", minWidth: 200 }}>
                    Deliverable
                  </TableCell>
                  <TableCell sx={{ fontWeight: 700, color: "#fff", minWidth: 150 }}>
              ...
              <TableBody>
                {value.map((item, i) => (
                  <TableRow
                    key={i}
                    sx={{ "&:hover": { bgcolor: "rgba(243, 168, 51,0.03)" } }}
                  >
                    <TableCell>
        ...
        return (
          ...
          >
            <Table>
              <TableHead>
                <TableRow sx={{ background: colorScheme.gradient }}>
                  <TableCell sx={{ fontWeight: 700, color: "#fff", minWidth: 180 }}>
                    Item
                  </TableCell>
                  <TableCell
                    sx={{ fontWeight: 700, color: "#fff", minWidth: 100 }}
                    align="center"
                  >
                    Quantity
                  </TableCell>
                  <TableCell
                    sx={{ fontWeight: 700, color: "#fff", minWidth: 180 }}
                    align="right"
                  >
                    Estimated Cost (PKR)
                  </TableCell>
                ...
                {value.map((item, i) => (
                  ...
                  >
                    ...
                    <TableCell align="right">
                      <Typography sx={{ fontWeight: 600, color: "#f3a833" }}>
      ...
      return (
        <Box sx={{ ml: 2 }}>
          {Object.entries(value).map(([k, v]) => (
            <Box key={k} sx={{ mb: 1 }}>
              <Typography sx={{ fontWeight: 700, color: "#f3a833" }}>
                {k}:
              </Typography>
      ...
      <Box sx={{ p: { xs: 0, md: 4 } }}>
        ...
        >
          <Tabs
            ...
            onChange={(event, newValue) => {
              ...
              if (newValue === 1) {
                dispatch(setHasNewInsights(false));
              }
            }}
        ...
        {tabValue === 0 && (
          <Card elevation={0} sx={cardStyle}>
            <CardContent sx={{ p: { xs: 2, sm: 3 }, px: { xs: 0, sm: 3 } }}>
              <Box sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, alignItems: "center", mb: 4, textAlign: { xs: "center", sm: "left" } }}>
                <Box
                  sx={{
                    width: 64,
                    height: 64,
              ...
              <form onSubmit={handleSubmit(handleExtractInfo)}>
                ...
                {/* Groq Usage Calculation Indicator */}
                {tokenUsage?.groq && (
                  <Box
                    sx={{
                      mb: 3,
                  ...
                  >
                    ...
                    <Box sx={{ textAlign: "right" }}>
                      <Typography variant="h6" sx={{ fontWeight: 800, color: "#a855f7", lineHeight: 1 }}>
                        {tokenUsage.groq.percentage}%
                      </Typography>
                      <Typography variant="caption" sx={{ fontWeight: 600, color: "#9333ea" }}>
                        Remaining
                      </Typography>
                    </Box>
                  </Box>
                ...
                <Button
                  ...
                  sx={{
                    ...
                    textTransform: "none",
                    background: colorScheme.gradient,
                    boxShadow: "0 8px 25px rgba(243, 168, 51, 0.4)",
                    transition: "all 0.3s ease",
                    "&:hover": {
                      transform: "translateY(-2px)",
                      boxShadow: "0 12px 30px rgba(243, 168, 51, 0.6)",
                    },
                  }}
                >
                  {extracting ? "Extracting Insights..." : "Extract with AI"}
                </Button>
              </form>
            </CardContent>
          </Card>
                  ...
                  <Card
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        ...
                        boxShadow: "0 12px 30px rgba(243, 168, 51, 0.2)",
                        borderColor: colorScheme.primary,
                      },
                    }}
                  >
                    <CardContent sx={{ p: { xs: 2.5, sm: 4 }, px: { xs: 0, sm: 4 } }}>
