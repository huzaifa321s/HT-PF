    ...
    >
      <Card sx={{ ...cardStyle, borderRadius: { xs: 0, sm: 3 }, border: { xs: "none", sm: "2px solid #e0e7ff" } }}>
        <CardContent sx={{ p: { xs: 2, sm: 3, md: 4 }, px: { xs: 0, sm: 3, md: 4 } }}>
          ...
          <Typography variant="body2" sx={{ mb: 3, color: "#94a3b8", fontSize: { xs: "0.85rem", sm: "1rem" } }}>
                ...
                sx={{
                  bgcolor:
                    edit === "title"
                      ? "rgba(76,175,80,0.15)"
                      : "rgba(243, 168, 51,0.1)",
                  color: edit === "title" ? "#2e7d32" : "#f3a833",
                  "&:hover": {
                    bgcolor:
                      edit === "title"
                        ? "rgba(76,175,80,0.25)"
          ...
          <Box sx={{ mb: 4 }}>
                ...
                sx={{
                  bgcolor:
                    edit === "subtitle"
                      ? "rgba(76,175,80,0.15)"
                      : "rgba(243, 168, 51,0.1)",
                  color: edit === "subtitle" ? "#2e7d32" : "#f3a833",
                  "&:hover": {
                    bgcolor:
                      edit === "subtitle"
                        ? "rgba(76,175,80,0.25)"
            ...
            {edit === "subtitle" ? (
              ...
              <Typography
                ...
                sx={{ fontSize: { xs: "0.95rem", sm: "1.1rem" }, lineHeight: 1.7 }}
              >
              ...
              <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
                ...
                >
                  <Stack direction="row" spacing={2} alignItems="center">
                    {el.type === "image" ? (
                      <ImageIcon sx={{ color: "#f3a833", fontSize: 24 }} />
                    ) : (
                      <TextFields sx={{ color: "#f3a833", fontSize: 24 }} />
                    )}
                    <Typography fontWeight={700} color="#f3a833">
                      {el.type === "image"
                        ? `Image Block #${i + 1}`
                        : `Text Block #${i + 1}`}
                    </Typography>
                      ...
                      sx={{
                        bgcolor:
                          edit === el.id
                            ? "rgba(76,175,80,0.15)"
                            : "rgba(243, 168, 51,0.1)",
                        color: edit === el.id ? "#2e7d32" : "#f3a833",
                        "&:hover": {
                          bgcolor:
                            edit === el.id
                              ? "rgba(76,175,80,0.25)"
      ...
      >
        <DialogTitle
          sx={{ bgcolor: "#f3a833", color: "white", py: 3, fontWeight: 700 }}
        >
