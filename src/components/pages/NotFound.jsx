...
const NotFound = () => {
  const colorScheme = {
    ...
    hoverGradient: "linear-gradient(135deg, #E67E00 0%, #f8fafc 100%)",
  };
          ...
          <Box sx={{ position: "relative", zIndex: 1 }}>
            ...
            <Box
              sx={{
                ...
                alignItems: "center",
                justifyContent: "center",
                boxShadow: "0 16px 40px rgba(243, 168, 51, 0.3)",
              }}
            >
            ...
            >
              <Button
                ...
                sx={{
                  ...
                  fontWeight: 600,
                  borderRadius: 3,
                  boxShadow: "0 10px 30px rgba(243, 168, 51, 0.3)",
                  background: colorScheme.gradient,
                  minWidth: { xs: "100%", sm: "auto" },
                  "&:hover": {
                    background: colorScheme.hoverGradient,
                    boxShadow: "0 15px 40px rgba(243, 168, 51, 0.4)",
