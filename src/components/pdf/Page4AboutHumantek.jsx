  ...
  >
    Page Limit Exceeded
          ...
          <DialogContent sx={{ background: "rgba(255,255,255,0.7)", pt: 2 }}>
            <Typography sx={{ fontSize: "1rem", background: "linear-gradient(135deg, #f3a833 0%, #f59e0b 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              This page has exceeded the A4 height limit of <strong>{MAX_PAGE_HEIGHT}px</strong>.
            </Typography>
            <Typography sx={{ mt: 2, fontSize: "1rem", background: "linear-gradient(135deg, #f3a833 0%, #f59e0b 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              You can still <strong>edit or delete</strong> elements.
            </Typography>
            <Typography sx={{ mt: 1, fontSize: "1rem", background: "linear-gradient(135deg, #f3a833 0%, #f59e0b 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              To add more: delete some content or clone this page.
            </Typography>
          </DialogContent>
          <DialogActions sx={{ justifyContent: "center", pb: 2, background: "rgba(20, 20, 20, 0.8)" }}>
            <Tooltip title="Close the dialog" arrow>
              <Button
                ...
                sx={{
                  ...
                  "&:hover": { background: "linear-gradient(135deg, #eab308 0%, #d97706 100%)", transform: "translateY(-2px)", boxShadow: "0 12px 32px rgba(243, 168, 51, 0.5)" },
