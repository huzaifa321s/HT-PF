      ...
      >
        ...
        {footerText && (
          <Box sx={{ mt: 6 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "flex-start", backgroundColor: "#141414", padding: 2 }}>
  ...
  >
    Page Limit Exceeded
          ...
          <DialogActions sx={{ justifyContent: "center", pb: 2 }}>
            <Button onClick={() => setShowLimitModal(false)} variant="contained" sx={{ background: "linear-gradient(135deg, #f3a833 0%, #f59e0b 100%)" }}>
              Got it
            </Button>
          </DialogActions>
        </Dialog>
