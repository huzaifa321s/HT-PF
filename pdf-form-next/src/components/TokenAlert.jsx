            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 3 }}>
              ...
              <IconButton
                ...
                sx={{
                  ...
                  "&:hover": {
                    bgcolor: notifications.length > 0 ? "rgba(211, 47, 47, 0.22)" : "rgba(0,0,0,0.7)",
                  },
      ...
      >
        <DialogTitle sx={{ fontWeight: 800, fontSize: "1.6rem", textAlign: "center", py: 4 }}>
          <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 1.5 }}>
            <AutoAwesome sx={{ color: "#f3a833", fontSize: 36 }} />
        ...
        <DialogActions sx={{ p: 4, bgcolor: "rgba(243, 168, 51, 0.06)" }}>
          <Button
            ...
            sx={{
              ...
              boxShadow: "0 10px 30px rgba(243, 168, 51, 0.4)",
              "&:hover": { transform: "translateY(-3px)", boxShadow: "0 15px 40px rgba(243, 168, 51, 0.5)" },
            }}
          >
            Close
          </Button>
