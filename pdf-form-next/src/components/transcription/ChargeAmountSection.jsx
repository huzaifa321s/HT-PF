...
export default function ChargeAmountSection({ formData, setFormData, currency, mode }) {
  ...
  const paperStyle = {
    ...
    "&:hover": { transform: "translateY(-4px)", boxShadow: "0 16px 32px rgba(243, 168, 51,0.25)" },
  };
  ...
  const inputStyle = {
    "& .MuiOutlinedInput-root": {
      borderRadius: 3,
      bgcolor: "#141414",
      "& fieldset": { borderColor: "rgba(243, 168, 51,0.3)", borderWidth: 2 },
      "&:hover fieldset": { borderColor: "rgba(243, 168, 51,0.5)" },
      ...
      {services.length > 0 && (
        <>
          ...
          <Box display="flex" justifyContent="space-between" alignItems="center">
            ...
            <Typography variant="h6" fontWeight={700} sx={{ background: "linear-gradient(135deg, #f3a833 0%, #f59e0b 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
  ...
  return (
    <Box
      ...
      sx={{
        ...
        "&:hover": { boxShadow: "0 8px 20px rgba(243, 168, 51,0.15)" },
      }}
    >
