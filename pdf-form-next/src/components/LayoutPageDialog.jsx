    ...
    >
      ...
      <Box
        sx={{
          ...
          borderBottom: "2px solid rgba(243, 168, 51, 0.3)",
        }}
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          ...
          >
            <CheckCircleIcon sx={{ fontSize: 24, color: "#f3a833" }} />
          </Box>
          <Typography
            variant="h6"
            sx={{
      ...
      <Divider sx={{ borderColor: "rgba(243, 168, 51, 0.3)" }} />
      ...
      >
        <motion.img
          ...
          style={{
            ...
            maxHeight: "60vh",
            borderRadius: "16px",
            border: "2px solid rgba(243, 168, 51, 0.3)",
