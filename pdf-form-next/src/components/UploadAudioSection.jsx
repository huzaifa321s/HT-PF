  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 4 }}>
        ...
        >
          <MicIcon sx={{ fontSize: { xs: 28, sm: 36 }, color: '#f3a833' }} />
        </Box>
        <Box>
          <Typography
            variant="h4"
      ...
      <Box
        sx={{
          border: '2px dashed',
          borderColor: isDragging ? '#fff' : uploading ? '#f3a833' : 'rgba(0,0,0,0.12)',
          borderRadius: 4,
          p: { xs: 2.5, sm: 4 },
          textAlign: 'center',
      ...
      {file && (
        ...
        >
          <Typography variant="body2" sx={{ fontWeight: 600, color: '#e2e8f0', fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>
